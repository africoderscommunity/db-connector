...
import { Database, Play, Square, Trash2, Plus, Copy, RefreshCw, Info, Terminal, AlertCircle, CheckCircle, Clock, Download } from 'lucide-react';
...
const handleSetPassword = async (id) => {
  try {
    ...
    alert("Password authentication enabled. Restart PostgreSQL instance to apply changes.");
    setInstances(prev =>
  ...
  const handleCreateInstance = async () => {
    ...
    try {
      ...
      showNotification(`${createEngine.toUpperCase()} instance created successfully!`);
  ...
  const handleDeleteInstance = async (id) => {
    ...
    if (!confirm('Are you sure you want to delete this instance? All data will be lost.')) {
      return;
    }
  ...
  const handleShowConnectionInfo = async (id) => {
    ...
    try {
      ...
      showNotification(`Failed to get connection info: ${error.message}`, 'error');
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold mb-2">Database Engine Not Available</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400">Manage your local database instances</p>
          </div>
      ...
      <div className="max-w-7xl mx-auto mb-6">
        <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
          <h3 className="text-sm font-semibold text-gray-400 mb-3">Installed Binaries</h3>
            ...
            {Object.entries(binaries).map(([engine, info]) => (
              <div key={engine} className="flex items-center gap-2">
                ...
                <div>
                  ...
                  {info.isSystem && (
                    <span className="text-xs text-blue-400">System Install</span>
                  )}
                </div>
              </div>
            ))}
      ...
      <div className="max-w-7xl mx-auto">
        {instances.length === 0 ? (
          <div className="bg-gray-800 rounded-lg p-12 text-center border border-gray-700">
            ...
            <h3 className="text-xl font-semibold mb-2">No database instances</h3>
            <p className="text-gray-400 mb-6">Create your first database instance to get started</p>
            <button
              onClick={() => setShowCreateModal(true)}
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <span className="text-4xl">{getEngineIcon(instance.engine)}</span>
                    <div>
                      <h3 className="text-xl font-bold capitalize">{instance.engine}</h3>
                      <p className="text-sm text-gray-400">Port {instance.port}</p>
                    </div>
                  </div>
                ...
                <div className="space-y-2 mb-4 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className={`font-semibold ${instance.status === 'running' ? 'text-green-400' : 'text-gray-400'}`}>
                      {instance.status}
                    </span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  {instance.username && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono text-xs">{instance.username}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    title={instance.status === 'running' ? 'Stop instance first' : 'Delete'}
                  >
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-40 p-4">
          <div className="bg-gray-800 rounded-xl p-6 w-full max-w-md border border-gray-700">
            <h2 className="text-2xl font-bold mb-6">Create Database Instance</h2>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-2">Database Engine</label>
                <select
                  value={createEngine}
                  onChange={(e) => { setCreateEngine(e.target.value); setCreatePort(''); }}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-gray-700 rounded-lg border border-gray-600 focus:border-blue-500 focus:outline-none"
                />
                <p className="text-xs text-gray-400 mt-1">Leave empty to use default port</p>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  {createEngine === 'mongo' && <option value="6.0.6">6.0.6</option>}
                  ...
                  {createEngine === 'mysql' && <option value="8.1.0">8.1.0</option>}
                </select>
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-gray-900 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-400">Connection String</span>
                  <button
                    onClick={() => copyToClipboard(connectionInfo.connectionString)}
                ...
                <code className="text-sm text-green-400 break-all block">{connectionInfo.connectionString}</code>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-900 rounded-lg p-4">
                  ...
                  <div className="font-mono">{connectionInfo.username || 'N/A'}</div>
                </div>
                <div className="bg-gray-900 rounded-lg p-4">
              ...
              {connectionInfo.password !== null && (
                <div className="bg-gray-900 rounded-lg p-4">
                  ...
                  <div className="font-mono">{connectionInfo.password || '(none - trust authentication)'}</div>
                </div>
              )}
              ...
              {connectionInfo.note && (
                <div className="bg-blue-900 bg-opacity-30 border border-blue-700 rounded-lg p-4">
                  <div className="flex gap-2">
                    ...
                    <p className="text-sm text-blue-200">{connectionInfo.note}</p>
                  </div>
                </div>
              )}
            </div>
